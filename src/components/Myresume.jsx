        ...
        <section id="education-section" aria-labelledby="education-title">
          ...
          <article className="timeline-item">
            <div className="content-box">
              ...
              <div className="title">Learning the backend</div>
              <div className="description">
              I am currently learning backend development. That is, I am studying server-side technologies such as databases, APIs, authentication, and other backend processes, while also improving my practical skills. My goal is to become a backend developer who can build stable and efficient systems.
              </div>
            </div>
          </article>
        </section>
